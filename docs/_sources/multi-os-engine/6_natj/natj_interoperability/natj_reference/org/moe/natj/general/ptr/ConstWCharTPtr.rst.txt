...
.. java:type:: public interface ConstWCharTPtr extends ConstPtr<Integer>

   Constant native sized signed Long pointer interface. - Element size is always `sizeof(wchar_t)`
...
.. java:method:: @Override public ConstWCharTPtr getGuarded(int length)
   :outertype: ConstWCharTPtr

getGuarded
^^^^^^^^^^

.. java:method:: @Override public ConstWCharTPtr getGuarded(int fromIndex, int toIndex)
   :outertype: ConstWCharTPtr
...
.. java:method:: @Override public ConstWCharTPtr ofs(int elemOffset)
   :outertype: ConstWCharTPtr
