...
.. java:type:: public interface IntPtr extends Ptr<Integer>, ConstIntPtr
...
.. java:method:: @Override public IntPtr getGuarded(int length)
   :outertype: IntPtr

getGuarded
^^^^^^^^^^

.. java:method:: @Override public IntPtr getGuarded(int fromIndex, int toIndex)
   :outertype: IntPtr

ofs
^^^

.. java:method:: @Override public IntPtr ofs(int elemOffset)
   :outertype: IntPtr
