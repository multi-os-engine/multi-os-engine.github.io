...
.. java:type:: public interface ConstCharPtr extends ConstPtr<Character>
...
.. java:method:: public void copyTo(char[] dest)
   :outertype: ConstCharPtr
...
.. java:method:: public void copyTo(char[] dest, int length)
   :outertype: ConstCharPtr
...
.. java:method:: public void copyTo(int srcOffset, char[] dest, int destOffset, int length)
   :outertype: ConstCharPtr
...
.. java:method:: @Override public ConstCharPtr getGuarded(int length)
   :outertype: ConstCharPtr

getGuarded
^^^^^^^^^^

.. java:method:: @Override public ConstCharPtr getGuarded(int fromIndex, int toIndex)
   :outertype: ConstCharPtr

getValue
^^^^^^^^

.. java:method:: public char getValue()
   :outertype: ConstCharPtr
...
.. java:method:: public char getValue(int idx)
   :outertype: ConstCharPtr
...
.. java:method:: @Override public ConstCharPtr ofs(int elemOffset)
   :outertype: ConstCharPtr

toCharArray
^^^^^^^^^^^

.. java:method:: public char[] toCharArray(int length)
   :outertype: ConstCharPtr
...
.. java:method:: public char[] toCharArray(int fromIndex, int toIndex)
   :outertype: ConstCharPtr
