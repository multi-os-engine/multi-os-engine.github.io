...
.. java:type:: public interface ConstLongPtr extends ConstPtr<Long>
...
.. java:method:: @Override public ConstLongPtr getGuarded(int length)
   :outertype: ConstLongPtr

getGuarded
^^^^^^^^^^

.. java:method:: @Override public ConstLongPtr getGuarded(int fromIndex, int toIndex)
   :outertype: ConstLongPtr
...
.. java:method:: @Override public ConstLongPtr ofs(int elemOffset)
   :outertype: ConstLongPtr
