...
.. java:type:: public interface ConstDoublePtr extends ConstPtr<Double>
...
.. java:method:: @Override public ConstDoublePtr getGuarded(int length)
   :outertype: ConstDoublePtr

getGuarded
^^^^^^^^^^

.. java:method:: @Override public ConstDoublePtr getGuarded(int fromIndex, int toIndex)
   :outertype: ConstDoublePtr
...
.. java:method:: @Override public ConstDoublePtr ofs(int elemOffset)
   :outertype: ConstDoublePtr
