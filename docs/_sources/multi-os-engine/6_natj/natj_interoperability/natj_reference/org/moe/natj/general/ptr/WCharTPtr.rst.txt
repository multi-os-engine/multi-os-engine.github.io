...
.. java:type:: public interface WCharTPtr extends Ptr<Integer>, ConstWCharTPtr

   Native sized Long pointer interface. - Element size is always `sizeof(wchar_t)`
...
.. java:method:: public void copyFrom(int[] src)
   :outertype: WCharTPtr
...
.. java:method:: public void copyFrom(int[] src, int destOffset)
   :outertype: WCharTPtr
...
.. java:method:: public void copyFrom(int[] src, int destOffset, int length)
   :outertype: WCharTPtr
...
.. java:method:: public void copyFrom(int[] src, int srcOffset, int destOffset, int length)
   :outertype: WCharTPtr
...
.. java:method:: @Override public WCharTPtr getGuarded(int length)
   :outertype: WCharTPtr

getGuarded
^^^^^^^^^^

.. java:method:: @Override public WCharTPtr getGuarded(int fromIndex, int toIndex)
   :outertype: WCharTPtr

ofs
^^^

.. java:method:: @Override public WCharTPtr ofs(int elemOffset)
   :outertype: WCharTPtr

setValue
^^^^^^^^

.. java:method:: public void setValue(int value)
   :outertype: WCharTPtr
...
.. java:method:: public void setValue(int idx, int value)
   :outertype: WCharTPtr
