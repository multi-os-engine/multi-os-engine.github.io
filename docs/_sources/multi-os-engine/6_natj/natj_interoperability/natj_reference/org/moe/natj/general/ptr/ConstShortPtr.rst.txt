...
.. java:type:: public interface ConstShortPtr extends ConstPtr<Short>
...
.. java:method:: public void copyTo(short[] dest)
   :outertype: ConstShortPtr
...
.. java:method:: public void copyTo(short[] dest, int length)
   :outertype: ConstShortPtr
...
.. java:method:: public void copyTo(int srcOffset, short[] dest, int destOffset, int length)
   :outertype: ConstShortPtr
...
.. java:method:: @Override public ConstShortPtr getGuarded(int length)
   :outertype: ConstShortPtr

getGuarded
^^^^^^^^^^

.. java:method:: @Override public ConstShortPtr getGuarded(int fromIndex, int toIndex)
   :outertype: ConstShortPtr

getValue
^^^^^^^^

.. java:method:: public short getValue()
   :outertype: ConstShortPtr
...
.. java:method:: public short getValue(int idx)
   :outertype: ConstShortPtr
...
.. java:method:: @Override public ConstShortPtr ofs(int elemOffset)
   :outertype: ConstShortPtr

toShortArray
^^^^^^^^^^^^

.. java:method:: public short[] toShortArray(int length)
   :outertype: ConstShortPtr
...
.. java:method:: public short[] toShortArray(int fromIndex, int toIndex)
   :outertype: ConstShortPtr
