...
.. java:type:: public interface NULongPtr extends Ptr<Long>, ConstNULongPtr

   Native sized unsigned Long pointer interface. - Element size is always `sizeof(unsigned long)`
...
.. java:method:: @Override public NULongPtr getGuarded(int length)
   :outertype: NULongPtr

getGuarded
^^^^^^^^^^

.. java:method:: @Override public NULongPtr getGuarded(int fromIndex, int toIndex)
   :outertype: NULongPtr

ofs
^^^

.. java:method:: @Override public NULongPtr ofs(int elemOffset)
   :outertype: NULongPtr
