...
.. java:type:: public interface NFloatPtr extends Ptr<Double>, ConstNFloatPtr
...
.. java:method:: @Override public NFloatPtr getGuarded(int length)
   :outertype: NFloatPtr

getGuarded
^^^^^^^^^^

.. java:method:: @Override public NFloatPtr getGuarded(int fromIndex, int toIndex)
   :outertype: NFloatPtr

ofs
^^^

.. java:method:: @Override public NFloatPtr ofs(int elemOffset)
   :outertype: NFloatPtr
