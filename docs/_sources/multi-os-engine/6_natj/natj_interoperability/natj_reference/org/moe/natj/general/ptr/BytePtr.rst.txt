...
.. java:type:: public interface BytePtr extends Ptr<Byte>, ConstBytePtr
...
.. java:method:: public void copyFrom(byte[] src)
   :outertype: BytePtr
...
.. java:method:: public void copyFrom(byte[] src, int destOffset)
   :outertype: BytePtr
...
.. java:method:: public void copyFrom(byte[] src, int destOffset, int length)
   :outertype: BytePtr
...
.. java:method:: public void copyFrom(byte[] src, int srcOffset, int destOffset, int length)
   :outertype: BytePtr
...
.. java:method:: @Override public BytePtr getGuarded(int length)
   :outertype: BytePtr

getGuarded
^^^^^^^^^^

.. java:method:: @Override public BytePtr getGuarded(int fromIndex, int toIndex)
   :outertype: BytePtr

ofs
^^^

.. java:method:: @Override public BytePtr ofs(int elemOffset)
   :outertype: BytePtr

setValue
^^^^^^^^

.. java:method:: public void setValue(byte value)
   :outertype: BytePtr
...
.. java:method:: public void setValue(int idx, byte value)
   :outertype: BytePtr
