...
.. java:type:: public interface ConstFloatPtr extends ConstPtr<Float>
...
.. java:method:: public void copyTo(float[] dest)
   :outertype: ConstFloatPtr
...
.. java:method:: public void copyTo(float[] dest, int length)
   :outertype: ConstFloatPtr
...
.. java:method:: public void copyTo(int srcOffset, float[] dest, int destOffset, int length)
   :outertype: ConstFloatPtr
...
.. java:method:: @Override public ConstFloatPtr getGuarded(int length)
   :outertype: ConstFloatPtr

getGuarded
^^^^^^^^^^

.. java:method:: @Override public ConstFloatPtr getGuarded(int fromIndex, int toIndex)
   :outertype: ConstFloatPtr
...
.. java:method:: public float getValue(int idx)
   :outertype: ConstFloatPtr
...
.. java:method:: @Override public ConstFloatPtr ofs(int elemOffset)
   :outertype: ConstFloatPtr

toFloatArray
^^^^^^^^^^^^

.. java:method:: public float[] toFloatArray(int length)
   :outertype: ConstFloatPtr
...
.. java:method:: public float[] toFloatArray(int fromIndex, int toIndex)
   :outertype: ConstFloatPtr
